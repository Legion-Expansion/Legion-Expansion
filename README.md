...
- update pa/units/unit_list_legion.json (the vanilla pa/units/unit_list.json is generated by src/utils/update_shadows.py)
- update pa/ai/unit_maps/legion.json
- update ui/mods/com.pa.legion-expansion/common.js if the unit can build
- add a build bar image and give it a grid position in ui/mods/com.pa.legion-expansion/shared_build.js
- add a strategic icon and list it in ui/mods/com.pa.legion-expansion/icon_atlas.js
...
- rename in pa/units/unit_list_legion.json
- update pa/ai/unit_maps/legion.json
- rename in ui/mods/com.pa.legion-expansion/common.js
- rename the build bar image and update its entry in ui/mods/com.pa.legion-expansion/shared_build.js
- rename the strategic icon and update its entry in ui/mods/com.pa.legion-expansion/icon_atlas.js
