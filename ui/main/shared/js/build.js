		...
		self.SpecIdToGridMap = ko.observable(
			{
				...
				"/pa/units/land/tank_laser_adv/tank_laser_adv.json": ["vehicle", 6],  // leveler
				"/pa/units/land/tank_heavy_armor/tank_heavy_armor.json": ["vehicle", 7], // vanguard
				"/pa/units/land/tank_heavy_mortar/tank_heavy_mortar.json": ["vehicle", 8], // sheller
				"/pa/units/land/fabrication_vehicle/fabrication_vehicle.json": ["vehicle", 10],                        
				"/pa/units/land/tank_light_laser/tank_light_laser.json": ["vehicle", 11], // bolo
				"/pa/units/land/tank_armor/tank_armor.json": ["vehicle", 12], // flame
				"/pa/units/land/land_scout/land_scout.json": ["vehicle", 13], // skitter
				"/pa/units/land/aa_missile_vehicle/aa_missile_vehicle.json": ["vehicle", 14], // spinner 

				"/pa/units/land/fabrication_bot_adv/fabrication_bot_adv.json": ["bot", 5],
				"/pa/units/land/assault_bot_adv/assault_bot_adv.json": ["bot", 6], // slammer
				"/pa/units/land/bot_sniper/bot_sniper.json": ["bot", 7], // sniper
				"/pa/units/land/fabrication_bot_combat_adv/fabrication_bot_combat_adv.json": ["bot", 8],
				"/pa/units/land/bot_bomb/bot_bomb.json": ["bot", 14], // boom
				"/pa/units/land/fabrication_bot/fabrication_bot.json": ["bot", 10],     
				"/pa/units/land/assault_bot/assault_bot.json": ["bot", 11],  // dox
				"/pa/units/land/bot_grenadier/bot_grenadier.json": ["bot", 12],  // grenadier
				"/pa/units/land/fabrication_bot_combat/fabrication_bot_combat.json": ["bot", 13],
				"/pa/units/land/bot_tactical_missile/bot_tactical_missile.json": ["bot", 9],  // bluehawk
