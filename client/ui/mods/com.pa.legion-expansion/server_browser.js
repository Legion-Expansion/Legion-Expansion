(function () {
  ...
  $("#game-list .col-md-3").append(
    '<span class="lbl_titans lbl_legion" data-bind="visible: $data.legion"><noloc>Legion<noloc></span>'
  );
  $("#detail-pane div")
    .first()
    .append(
      '<div class="lbl_titans lbl_legion details" data-bind="visible: $data.legion, css: { lbl_titans_missing: $data.is_missing_content }"><loc>Legion Expansion</loc></div>'
    );
})();
