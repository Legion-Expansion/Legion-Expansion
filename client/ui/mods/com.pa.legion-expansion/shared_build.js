    ...
    if (_.has(Build, "HotkeyModel.SpecIdToGridMap"))
      _.assign(Build.HotkeyModel.SpecIdToGridMap, {
        ...
        "/pa/units/land/l_flame_turret/l_flame_turret.json": [
          "L_combat",
          3,
          { row: 0, column: 3, titans: true },
        ],
        "/pa/units/land/l_artillery_long/l_artillery_long.json": [
          "L_combat",
          2,
          { row: 0, column: 2, titans: true },
        ],
        ...
        "/pa/units/land/l_shield_gen/l_shield_gen.json": [
          "L_combat",
          1,
          { row: 0, column: 1, titans: true },
        ],
        "/pa/units/land/l_nuke_launcher/l_nuke_launcher.json": [
          "L_combat",
          4,
          { row: 0, column: 4, titans: true },
        ],
        ...
        "/pa/units/land/l_swarm_hive/l_swarm_hive.json": [
          "L_combat",
          8,
          { row: 1, column: 2, titans: true },
        ],
        ...
        "/pa/units/land/l_radar_adv/l_radar_adv.json": [
          "L_utility",
          8,
          { row: 1, column: 2, titans: true },
        ],
        ...
        "/pa/units/land/l_radar/l_radar.json": [
          "L_utility",
          14,
          { row: 2, column: 2, titans: true },
        ],
        "/pa/units/land/l_storage/l_storage.json": [
          "L_utility",
          15,
          { row: 2, column: 3, titans: true },
        ],
        ...
        "/pa/units/land/l_riot_bot/l_riot_bot.json": [
          "L_bot",
          7,
          { row: 1, column: 1, titans: true },
        ],
        ...
        "/pa/units/land/l_bot_aa_adv/l_bot_aa_adv.json": [
          "L_bot",
          9,
          { row: 1, column: 3, titans: true },
        ],
        ...
        "/pa/units/land/l_necromancer/l_necromancer.json": [
          "L_bot",
          11,
          { row: 1, column: 5, titans: true },
        ],
        ...
        "/pa/units/land/l_assault_bot/l_assault_bot.json": [
          "L_bot",
          13,
          { row: 2, column: 1, titans: true },
        ],
        "/pa/units/land/l_sniper_bot/l_sniper_bot.json": [
          "L_bot",
          14,
          { row: 2, column: 2, titans: true },
        ],
        "/pa/units/land/l_bot_aa/l_bot_aa.json": [
          "L_bot",
          15,
          { row: 2, column: 3, titans: true },
        ],
        "/pa/units/land/l_bot_bomb/l_bot_bomb.json": [
          "L_bot",
          16,
          { row: 2, column: 4, titans: true },
        ],
        "/pa/units/land/l_scout_bot/l_scout_bot.json": [
          "L_bot",
          17,
          { row: 2, column: 5, titans: true },
        ],
        ...
        "/pa/units/air/l_gunship/l_gunship.json": [
          "L_air",
          8,
          { row: 1, column: 2, titans: true },
        ],
        "/pa/units/air/l_air_carrier/l_air_carrier.json": [
          "L_air",
          9,
          { row: 1, column: 3, titans: true },
        ],
        ...
        "/pa/units/air/l_fighter/l_fighter.json": [
          "L_air",
          13,
          { row: 2, column: 1, titans: true },
        ],
        "/pa/units/air/l_bomber/l_bomber.json": [
          "L_air",
          14,
          { row: 2, column: 2, titans: true },
        ],
        "/pa/units/air/l_raider/l_raider.json": [
          "L_air",
          15,
          { row: 2, column: 3, titans: true },
        ],
        "/pa/units/air/l_transport/l_transport.json": [
          "L_air",
          16,
          { row: 2, column: 4, titans: true },
        ],
        "/pa/units/air/l_air_bomb/l_air_bomb.json": [
          "L_air",
          17,
          { row: 2, column: 5, titans: true },
        ],
        "/pa/units/air/l_firestarter/l_firestarter.json": [
          "L_air",
          10,
          { row: 1, column: 4, titans: true },
        ],
        ...
        "/pa/units/sea/l_sea_tank/l_sea_tank.json": [
          "L_sea",
          7,
          { row: 1, column: 1, titans: true },
        ],
        "/pa/units/sea/l_battleship/l_battleship.json": [
          "L_sea",
          8,
          { row: 1, column: 2, titans: true },
        ],
        "/pa/units/sea/l_missile_ship/l_missile_ship.json": [
          "L_sea",
          9,
          { row: 1, column: 3, titans: true },
        ],
        ...
        "/pa/units/sea/l_sea_scout/l_sea_scout.json": [
          "L_sea",
          13,
          { row: 2, column: 1, titans: true },
        ],
        "/pa/units/sea/l_destroyer/l_destroyer.json": [
          "L_sea",
          14,
          { row: 2, column: 2, titans: true },
        ],
        "/pa/units/sea/l_attack_sub/l_attack_sub.json": [
          "L_sea",
          15,
          { row: 2, column: 3, titans: true },
        ],
        "/pa/units/sea/l_frigate/l_frigate.json": [
          "L_sea",
          16,
          { row: 2, column: 4, titans: true },
        ],
        ...
        "/pa/units/land/l_land_mine/l_land_mine.json": [
          "L_ammo",
          10,
          { row: 2, column: 4, titans: true },
        ],
        "/pa/units/sea/l_sea_mine/l_sea_mine.json": [
          "L_ammo",
          12,
          { row: 2, column: 0, titans: true },
        ],
        ...
        "/pa/units/air/l_titan_air/l_titan_air.json": [
          "L_factory",
          2,
          { row: 0, column: 2, titans: true },
        ],
        "/pa/units/land/l_titan_bot/l_titan_bot.json": [
          "L_factory",
          3,
          { row: 0, column: 3, titans: true },
        ],
