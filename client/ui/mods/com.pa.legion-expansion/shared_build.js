...
if ( ! legionExpansion_sharedbuildLoaded )
{
    ...
    function legionExpansion()
    {
        ...
        var legionBuild = {
          "/pa/units/air/l_flying_teleporter/l_flying_teleporter.json": [ "L_factory", 0, {row: 0, column: 0, titans: true}],
          "/pa/units/land/l_unit_cannon/l_unit_cannon.json": [ "L_factory", 6, {row: 1, column: 0, titans: true}],
          "/pa/units/sea/l_naval_factory_adv/l_naval_factory_adv.json": [ "L_factory", 7, {row: 1, column: 1, titans: true}],
          "/pa/units/air/l_air_factory_adv/l_air_factory_adv.json": [ "L_factory", 8, {row: 1, column: 2, titans: true}],
          "/pa/units/land/l_bot_factory_adv/l_bot_factory_adv.json": [ "L_factory", 9, {row: 1, column: 3, titans: true}],
          "/pa/units/land/l_vehicle_factory_adv/l_vehicle_factory_adv.json": [ "L_factory", 10, {row: 1, column: 4, titans: true}],
          "/pa/units/orbital/l_orbital_launcher/l_orbital_launcher.json": [ "L_factory", 12, {row: 2, column: 0, titans: true}],
          "/pa/units/sea/l_naval_factory/l_naval_factory.json": [ "L_factory", 13, {row: 2, column: 1, titans: true}],
          "/pa/units/air/l_air_factory/l_air_factory.json": [ "L_factory", 14, {row: 2, column: 2, titans: true}],
          "/pa/units/land/l_bot_factory/l_bot_factory.json": [ "L_factory", 15, {row: 2, column: 3, titans: true}],
          "/pa/units/land/l_vehicle_factory/l_vehicle_factory.json": [ "L_factory", 16, {row: 2, column: 4, titans: true}],

          "/pa/units/land/l_flame_turret/l_flame_turret.json": [ "L_combat", 3, {row: 0, column: 3, titans: true}],
          "/pa/units/land/l_artillery_long/l_artillery_long.json": [ "L_combat", 2, {row: 0, column: 2, titans: true}],
          "/pa/units/land/l_rocket_barrage/l_rocket_barrage.json": [ "L_combat", 0, {row: 0, column: 0, titans: true}],
          "/pa/units/land/l_shield_gen/l_shield_gen.json": [ "L_combat", 1, {row: 0, column: 1, titans: true}],
          "/pa/units/land/l_nuke_launcher/l_nuke_launcher.json": [ "L_combat", 4, {row: 0, column: 4, titans: true}],
          "/pa/units/land/l_t1_turret_adv/l_t1_turret_adv.json": [ "L_combat", 6, {row: 1, column: 0, titans: true}],
          ...
          "/pa/units/land/l_anti_nuke_launcher/l_anti_nuke_launcher.json": [ "L_combat", 10, {row: 1, column: 4, titans: true}],
          "/pa/units/land/l_t1_turret_basic/l_t1_turret_basic.json": [ "L_combat", 12, {row: 2, column: 0, titans: true}],
          ...
          "/pa/units/sea/l_torpedo_launcher/l_torpedo_launcher.json": [ "L_combat", 15, {row: 2, column: 3, titans: true}],
          "/pa/units/orbital/l_ion_defense/l_ion_defense.json": [ "L_combat", 16, {row: 2, column: 4, titans: true}],

          "/pa/units/land/l_control_module/l_control_module.json": [ "L_utility", 1, {row: 0, column: 1, titans: true}],
          "/pa/units/land/l_energy_plant_adv/l_energy_plant_adv.json": [ "L_utility", 3, {row: 0, column: 3, titans: true}],
          "/pa/units/land/l_mex_adv/l_mex_adv.json": [ "L_utility", 4, {row: 0, column: 4, titans: true}],
          "/pa/units/orbital/l_deep_space_radar/l_deep_space_radar.json": [ "L_utility", 5, {row: 0, column: 5, titans: true}],
          "/pa/units/orbital/l_delta_v_engine/l_delta_v_engine.json": [ "L_utility", 7, {row: 1, column: 1, titans: true}],
          "/pa/units/land/l_radar_adv/l_radar_adv.json": [ "L_utility", 8, {row: 1, column: 2, titans: true}],
          "/pa/units/land/l_energy_plant/l_energy_plant.json": [ "L_utility", 9, {row: 1, column: 3, titans: true}],
          "/pa/units/land/l_mex/l_mex.json": [ "L_utility", 10, {row: 1, column: 4, titans: true}],
          ...
          "/pa/units/land/l_radar/l_radar.json": [ "L_utility", 14, {row: 2, column: 2, titans: true}],
          "/pa/units/land/l_storage/l_storage.json": [ "L_utility", 15, {row: 2, column: 3, titans: true}],
          ...
          "/pa/units/orbital/l_orbital_dropper/l_orbital_dropper.json": [ "L_orbital_structure", 15, {row: 2, column: 3, titans: true}],
          ...
          "/pa/units/air/l_titan_air/l_titan_air.json": [ "L_factory", 2, {row: 0, column: 2, titans: true}],
          "/pa/units/land/l_titan_bot/l_titan_bot.json": [ "L_factory", 3, {row: 0, column: 3, titans: true}],
          "/pa/units/land/l_titan_vehicle/l_titan_vehicle.json": [ "L_factory", 4, {row: 0, column: 4, titans: true}],
          "/pa/units/orbital/l_titan_orbital/l_titan_orbital.json": [ "L_orbital_structure", 6, {row: 1, column: 0, titans: true}],
