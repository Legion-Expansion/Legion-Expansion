...
if ( ! legionExpansionLoaded )
{
    ...
    function legionExpansion()
    {
        ...
        var legionIcons = {
            ...
            "l_bot_bomb": ["bot_bomb"],
            "l_bot_bomb_ammo": ["bot_bomb"],
            "l_bot_bomb_jump_ammo": ["bot_bomb"],
            "l_scout_bot": ["land_scout"],
            "l_scout_bot_land_ammo": ["land_scout"],
            "l_scout_bot_water_ammo": ["land_scout"],
            "l_scout_bot_radar_mode": ["land_scout"],
            "l_scout_bot_radar_mode_land_ammo": ["land_scout"],
            "l_scout_bot_radar_mode_water_ammo": ["land_scout"],
            "minion": ["bot_bomb"],
            "minion_ammo": ["bot_bomb"],
            "minion_jump_ammo": ["bot_bomb"],
